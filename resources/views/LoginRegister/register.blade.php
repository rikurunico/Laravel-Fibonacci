...
.screen-1 .name input:focus::-moz-placeholder {
  color: transparent;
}
...
.screen-1 .email input:focus::-moz-placeholder {
  color: transparent;
}
.screen-1 .password {
  background: white;
...
.screen-1 .password input:focus::-moz-placeholder {
  color: transparent;
}
...
<div class="screen-1">
    ...
    <div class="footer"><a href="{{ route('login') }}">Login</a></div>
  </div>
</body>
</html>